# -*- coding: utf-8 -*-
import scrapy
from .exhibitorspidertemple import ExhibitorSpiderBasic

class XmstoneSpider(ExhibitorSpiderBasic):
    name = 'xmstone_spider'
    allowed_domains = ['www.stonefair.org.cn']
