from generalspider import ExhibitorSpiderBasic
#起始链接
class xmstoneSpider(ExhibitorSpiderBasic):
    ...
    sheetheader = ['序号','公司名称','英文名称','区号','电话1','电话2','传真','移动电话','联系人','邮箱','网址','地址','英文地址','企业类型','主营产品','主营行业','国家','城市','url']
    ...
    next_page_list = ['http://www.stonefair.org.cn/Exhibitor/ExhibitorList.asp?page={}'.format(page) for page in range(1, 91)]
